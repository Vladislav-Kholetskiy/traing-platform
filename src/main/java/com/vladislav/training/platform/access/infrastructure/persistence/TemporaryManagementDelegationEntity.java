...
/**
 * JPA-сущность {@code TemporaryManagementDelegationEntity}.
 */
@Entity
@Table(name = "temporary_management_delegation")
public class TemporaryManagementDelegationEntity {
    ...
    protected TemporaryManagementDelegationEntity() {
    }
