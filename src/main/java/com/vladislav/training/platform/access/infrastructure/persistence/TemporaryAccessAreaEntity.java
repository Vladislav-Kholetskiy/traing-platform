...
/**
 * JPA-сущность {@code TemporaryAccessAreaEntity}.
 */
@Entity
@Table(name = "temporary_access_area")
public class TemporaryAccessAreaEntity {
    ...
    @Column(name = "access_scope_type", nullable = false)
    ...
    protected TemporaryAccessAreaEntity() {
    }
    ...
    public void setAccessScopeType(AccessScopeType accessScopeType) {
