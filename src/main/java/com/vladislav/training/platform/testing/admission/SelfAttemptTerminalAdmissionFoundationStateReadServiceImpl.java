...
/**
 * Реализация сервиса {@code SelfAttemptTerminalAdmissionFoundationStateReadServiceImpl}.
 */
@Service
@Transactional(readOnly = true)
@ConditionalOnBean(TestAttemptRepository.class)
class SelfAttemptTerminalAdmissionFoundationStateReadServiceImpl
    implements SelfAttemptTerminalAdmissionFoundationStateReadService {

    private final TestAttemptRepository testAttemptRepository;

    SelfAttemptTerminalAdmissionFoundationStateReadServiceImpl(TestAttemptRepository testAttemptRepository) {
        this.testAttemptRepository = testAttemptRepository;
    }

    @Override
    public SelfAttemptTerminalAdmissionFoundationState findSelfAttemptTerminalAdmissionFoundationState(
        Long actorUserId,
        Long testAttemptId
    ) {
        ...
        return new SelfAttemptTerminalAdmissionFoundationState(attempt.id(), attempt.testId());
    }
