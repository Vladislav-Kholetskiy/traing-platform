...
/**
 * Реализация сервиса {@code AssignedAnswerMutationAdmissionFoundationStateReadServiceImpl}.
 */
@Service
@Transactional(readOnly = true)
@ConditionalOnBean({TestAttemptRepository.class, AssignmentTestRepository.class})
class AssignedAnswerMutationAdmissionFoundationStateReadServiceImpl
    implements AssignedAnswerMutationAdmissionFoundationStateReadService {

    private final TestAttemptRepository testAttemptRepository;
    private final AssignmentTestRepository assignmentTestRepository;

    AssignedAnswerMutationAdmissionFoundationStateReadServiceImpl(
    ...
    @Override
    public AssignedAnswerMutationAdmissionFoundationState findAssignedAnswerMutationAdmissionFoundationState(
        Long actorUserId,
        Long testAttemptId
    ) {
        ...
        return new AssignedAnswerMutationAdmissionFoundationState(
            attempt.id(),
