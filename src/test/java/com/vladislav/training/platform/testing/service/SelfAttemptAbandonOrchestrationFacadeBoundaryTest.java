...
/**
 * Проверяет граничные случаи для {@code SelfAttemptAbandonSequencingService}.
 * Такие сценарии особенно важны на границах допустимого поведения.
 */

class SelfAttemptAbandonSequencingServiceBoundaryTest {

    @Test
    void selfAbandonOrchestrationFacadeDependsOnlyOnSelfAbandonOwner() {
    ...
    @Test
    void selfAbandonOrchestrationFacadeKeepsSelfAbandonOnlyVocabularyWithoutGenericCloseManagerDrift() {
        assertThat(Arrays.stream(SelfAttemptAbandonSequencingService.class.getDeclaredMethods())
