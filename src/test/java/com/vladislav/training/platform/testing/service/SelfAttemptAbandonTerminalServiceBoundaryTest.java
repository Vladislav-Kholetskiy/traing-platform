...
/**
 * Проверяет граничные случаи для {@code SelfAttemptAbandonTerminalService}.
 * Такие сценарии особенно важны на границах допустимого поведения.
 */
class SelfAttemptAbandonTerminalServiceBoundaryTest {

    @Test
    void selfAbandonTerminalServiceDependsOnlyOnSelfAbandonOwnerPathCollaborators() {
    ...
    @Test
    void selfAbandonTerminalServiceKeepsSelfAbandonVocabularyWithoutSubmitOrAssignedMerge() {
        assertThat(Arrays.stream(SelfAttemptAbandonTerminalService.class.getDeclaredMethods())
