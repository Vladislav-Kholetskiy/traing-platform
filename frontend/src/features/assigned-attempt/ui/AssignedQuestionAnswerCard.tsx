...
import type { AssignedTestContextQuestion } from '../../assigned-learning/model/assignedLearning';
import type { AssignedAttemptAnswerMutationRequest } from '../model/assignedAttempt';
import { localizeQuestionType } from '../../../shared/ui/presentation';

type AssignedQuestionAnswerCardProps = {
  index: number;
  question: AssignedTestContextQuestion;
  answerRequest: AssignedAttemptAnswerMutationRequest;
  isSavePending: boolean;
  isDeletePending: boolean;
  onChange: (nextRequest: AssignedAttemptAnswerMutationRequest) => void;
  onSave: () => void;
  onDelete: () => void;
};
...
export function AssignedQuestionAnswerCard({
  index,
  question,
  answerRequest,
  isSavePending,
  ...
  onSave,
  onDelete,
}: AssignedQuestionAnswerCardProps) {
      ...
      <Space direction="vertical" size="middle" style={{ width: '100%' }}>
        ...
        {question.questionType === 'SINGLE_CHOICE' ? (
          <Radio.Group
            ...
            onChange={(event) => handleSingleChoiceChange(event.target.value)}
          >
